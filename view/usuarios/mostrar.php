...
<head>
	...
	<link rel="icon" href="../assets/img/medicina.ico" type="image/x-icon"/>
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
									...
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												...
												<div class="notif-content">
													<span class="subject">Edwin Serin</span>
													<span class="block">
														Ok, Gracias !
													</span>
											...
											<a href="#">
												...
												<div class="notif-content">
													...
													<span class="block">
														Listos para presentar el proyecto...
													</span>
											...
											<a href="#">
												...
												<div class="notif-content">
													<span class="subject">Minchola</span>
													<span class="block">
														Go, Veranito?
													</span>
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								<li>
									<div class="dropdown-title">Tienes 0 notificaciones nuevas
									</div>
								</li>
								<li>
								...
								<li>
									<a class="see-all" href="javascript:void(0);">Ver todas las notificaciones
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										...
										<div class="dropdown-divider"></div>
										<a class="dropdown-item" href="../cerrarSesion.php">Cerrar Cesión</a>
									</li>
								</div>
							</ul>
						</li>
